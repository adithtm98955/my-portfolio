...
// Console Message
// ============================================
console.log('%c👋 Hello! Welcome to ADITH TM\'s Portfolio', 'color: #b60303; font-size: 20px; font-weight: bold;');
console.log('%cBuilt with ❤️ using HTML, CSS, JavaScript & Bootstrap', 'color: #d40404; font-size: 14px;');
